...
class Connection:
    def __init__(self):
        ...
        self.mycursor.execute("CREATE TABLE IF NOT EXISTS BLOODRECIPIENT(RECIPIENT_ID VARCHAR(20) PRIMARY KEY,REGISTRATION_ID VARCHAR(20),NAME VARCHAR(20),BLOOD_GROUP VARCHAR(20) ,DATE_0F_DONATION DATE , BLOOD_GROUP_REQUESTION VARCHAR(20) , BLOOD_QTY INT(4) , FOREIGN KEY (REGISTRATION_ID) REFERENCES REGISTRATION(REGISTRATION_ID));")
